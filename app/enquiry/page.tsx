    ...
    <main className="min-h-screen bg-[var(--bg-color)] flex items-center justify-center px-4">
      <div className="max-w-[600px] w-full text-center flex flex-col items-center gap-8">
        ...
        >
          ...
          >
            Opening the <br /> <span className="italic opacity-50">Channels.</span>
          </h1>
        </motion.div>
        ...
        >
          Our reservation and inquiry systems are being calibrated. 
          For immediate assistance, please visit us in person.
        </motion.p>
