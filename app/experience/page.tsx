    ...
    <main className="min-h-screen bg-[var(--bg-color)] flex items-center justify-center px-4">
      <div className="max-w-[600px] w-full text-center flex flex-col items-center gap-8">
        ...
        >
          ...
          >
            Refining the <br /> <span className="italic opacity-50">Sanctuary.</span>
          </h1>
        </motion.div>
        ...
        >
          We are currently curating this experience to meet our standards of excellence. 
          Return shortly to witness the evolution.
        </motion.p>
