      ...
      <div className="relative z-10 max-w-[1400px] mx-auto w-full px-4 md:px-8 pt-32 pb-16 md:pt-40 md:pb-20 lg:pt-16 lg:pb-12 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            >
              <motion.span variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="block">{HERO_DATA.headline.top}</motion.span>
              <motion.span variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="text-rose-100/40 italic font-light block">{HERO_DATA.headline.bottom}</motion.span>
            </motion.h1>
          </div>
